        ...
        <div className={`dropdown ${className}`}>
            {i18n.language && (
                <Dropdown
                    ...
                    btnClassName="flex items-center gap-2 rounded-full border border-slate-300 bg-white px-3 py-1.5 text-sm font-semibold text-slate-600 shadow-sm transition hover:border-[#ff9900] hover:text-[#ff9900]"
                    button={
                        <>
                            <div>
                ...
                >
                    <ul className="grid w-[280px] grid-cols-2 gap-2 !px-2 font-semibold text-slate-600">
