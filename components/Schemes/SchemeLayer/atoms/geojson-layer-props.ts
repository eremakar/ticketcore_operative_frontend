import { BinaryAttribute, LayerData, LayerProps } from '@deck.gl/core/src'
import PolygonLayerProps from 'deck.gl'
...
type SubLayersProps = {
  points: Partial<typeof ScatterplotLayerProps>
  lines: Partial<PathLayerProps>
  polygons: Partial<typeof PolygonLayerProps>
